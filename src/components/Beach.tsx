      ...
      <div className="mt-10 container max-w-7xl xs:w-10/12 mx-auto sm:w-9/12 lg:w-9/12 relative">
        <div>
          ...
          <div className="card flex justify-center items-center">
            {!isLoading ? (
              <ul className=" justify-items-center grid xs:grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4 h-screen overflow-auto">
...
// fixed bottom-0 left-0 w-full translate-y-2 h-auto
